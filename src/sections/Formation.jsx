                            ...
                            >
                                ...
                                <div className={`ml-12 md:ml-0 md:w-1/2 ${index % 2 === 0 ? 'md:pl-12' : 'md:pr-12'}`}>
                                    <SpotlightCard className="p-6">
                                        ...
                                        <h3 className="text-lg font-bold text-white mb-1">{formation.title}</h3>
                                        <p className="text-slate-300 font-medium text-sm mb-2">{formation.subtitle}</p>
                                        <p className="text-slate-500 text-sm mb-4">{formation.institution}</p>
