                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                <div className="w-11 h-11 mb-4 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-all duration-300">
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                <div className="w-11 h-11 mb-4 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-all duration-300">
                                    <svg className="w-5 h-5 text-slate-400 group-hover:text-white transition-colors translate-y-[-1px]" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                <div className="w-11 h-11 mb-4 rounded-full bg-white/5 flex items-center justify-center">
