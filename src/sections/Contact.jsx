                ...
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                <div className="w-12 h-12 mb-4 rounded-full bg-white/5 grid place-items-center group-hover:bg-white/10 transition-all duration-300">
                                    <svg className="w-5 h-5 text-slate-400 group-hover:text-white transition-colors block flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />        
                                    </svg>
                                </div>
                                <h3 className="font-medium text-white mb-1 text-sm">Email</h3>
                                <p className="text-[11px] text-slate-500 group-hover:text-slate-300 transition-colors break-all">zhengjimmy66@gmail.com</p>
                            </SpotlightCard>
                        </motion.a>
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                <div className="w-12 h-12 mb-4 rounded-full bg-white/5 grid place-items-center group-hover:bg-white/10 transition-all duration-300">
                                    <svg className="w-5 h-5 text-slate-400 group-hover:text-white transition-colors block flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                <div className="w-12 h-12 mb-4 rounded-full bg-white/5 grid place-items-center">
                                    <svg className="w-5 h-5 text-slate-400 block flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                        <SpotlightCard className="p-8">
                            ...
                            <p className="text-slate-400 mb-6 text-sm">Avril - Juillet 2026 • IUT d'Orsay</p>   
                            <a
                                href="mailto:zhengjimmy66@gmail.com?subject=Opportunité de stage - Jimmy ZHENG" 
                                className="inline-flex items-center gap-2 px-6 py-2.5 bg-white text-black font-medium text-sm rounded-full hover:bg-slate-200 transition-colors duration-300"
                            >
