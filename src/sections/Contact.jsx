                ...
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <div className="grid sm:grid-cols-3 gap-4 mb-10">
                        ...
                        >
                            ...
                            <p className="text-xs text-gray-400 group-hover:text-cyan-400 transition-colors">zhengjimmy66@gmail.com</p>
                        </a>
                        ...
                        >
                            ...
                            <p className="text-sm text-gray-400 group-hover:text-cyan-400 transition-colors">Mes projets</p>
                        </a>
                    </div>
