                ...
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                <div className="w-12 h-12 mb-4 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-all duration-300">
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                <div className="w-12 h-12 mb-4 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-all duration-300">
                                    <svg className="w-[18px] h-[18px] text-slate-400 group-hover:text-white transition-colors flex-shrink-0 translate-x-[0.5px]" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                        <SpotlightCard className="p-8">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2 text-center">Stage de 10 à 12 semaines</h3>    
                            <p className="text-slate-400 mb-6 text-sm text-center">Avril - Juillet 2026 • IUT d'Orsay</p>   
