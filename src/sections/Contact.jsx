            ...
            <div className="section-container">
                ...
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    >
                        ...
                        <br />
                        <span className="text-white">N'hésitez pas à me contacter pour toute opportunité.</span>
                    </motion.p>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                <div className="w-10 h-10 mb-4 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-colors">
                                    <svg className="w-5 h-5 text-slate-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                </div>
                                <h3 className="font-medium text-white mb-1 text-sm">Email</h3>
                                <p className="text-xs text-slate-500 group-hover:text-slate-300 transition-colors break-all">zhengjimmy66@gmail.com</p>
                            </SpotlightCard>
                        </motion.a>
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                ...
                                <p className="text-xs text-slate-500 group-hover:text-slate-300 transition-colors">07 67 69 69 93</p>
                            </SpotlightCard>
                        </motion.a>
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                ...
                                <p className="text-xs text-slate-500 group-hover:text-slate-300 transition-colors">Mon profil</p>
                            </SpotlightCard>
                        </motion.a>
                        ...
                        >
                            <SpotlightCard className="p-6 flex flex-col items-center h-full">
                                ...
                                <p className="text-xs text-slate-500">Paris 13e</p>
                            </SpotlightCard>
                        </motion.div>
                    </div>
