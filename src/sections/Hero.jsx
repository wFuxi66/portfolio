        ...
        <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="section-container text-center relative z-10">
                ...
                <p className="animate-slide-up opacity-0 delay-300 text-base sm:text-lg text-gray-500 mb-8 max-w-xl mx-auto">
                    BUT Informatique S3 • Parcours <span className="text-emerald-400 font-medium">Réseaux et Sécurité (B)</span>
                    <br />
                ...
                <div className="animate-slide-up opacity-0 delay-400 flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <a
                        ...
                        className="px-8 py-3 border border-cyan-600/50 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-600/10 transition-all duration-300 w-full sm:w-auto"
                    >
                        En savoir plus
                    </a>
                </div>
